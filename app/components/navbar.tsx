...
export default function NavBar() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl py-2 px-4 lg:px-8 lg:py-4 rounded-lg ">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        >
          <span className="text-black font-bold text-lg">ODIS</span>
        </Typography>
        ...
        variant="gradient" size="sm" className="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
          <span>Login</span>
        </Button>
       
        <IconButton
          variant="text"
          className="ml-auto h-6 w-6 text-inherit hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden bg-blue-300"
          ripple={false}
      ...
      <MobileNav open={openNav}>
        ...
        variant="gradient" size="sm" fullWidth className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
          <span >Login</span>
        </Button>
...
{showModal? (
<div id="authentication-modal" tabIndex={-1} aria-hidden="true" className="flex flex-row-reverse overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
